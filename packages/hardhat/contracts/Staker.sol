...
contract Staker {
  ...
  */
    ...
    modifier completed() {
        bool completed = exampleExternalContract.completed();
        require(completed, "Stake already has not yet completed!");
        _;
    }
  ...
  */
    function execute() public claimDeadlineReached(true) notCompleted {
        ...
        // clear balances mapping
        // iterate over the array to iterate over the mapping and reset all
        for (uint256 i = 0; i < stakers.length; i++) {
            delete balances[stakers[i]];
        }
  ...
  */
        ...
        completed
    {
        ...
        balances[user] = balances[user] + msg.value;
        depositTimestamps[user] = block.timestamp;
        emit Stake(user, msg.value);
    }
}
